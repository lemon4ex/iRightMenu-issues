...
> 🎉 [iRightMenu Pro](https://rm.byteage.com) has been released, supports a WYSIWYG menu editor and a powerful Lua plugin system. It also allows for the implementation of menu functionalities via scripting—offering faster performance, greater extensibility, and a design better suited for professional users.
